...
class tAguinaldoModel extends Model {
    public idAguinaldo!: number;
...
tAguinaldoModel.init(
    ...
    },
    {
        ...
        tableName: 'tAguinaldo',
        timestamps: false
    }
)

export default tAguinaldoModel